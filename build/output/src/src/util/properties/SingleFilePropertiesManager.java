...
public class SingleFilePropertiesManager implements IPropertiesManager {

    private HashMap<String, Properties> map = new HashMap<String, Properties>();

    public SingleFilePropertiesManager() {
    }

    public SingleFilePropertiesManager(String group) {
