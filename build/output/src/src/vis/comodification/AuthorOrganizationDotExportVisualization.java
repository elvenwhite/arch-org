...
import util.Graph;
import util.Node;
import vis.DotExportVisualization;

public class AuthorOrganizationDotExportVisualization extends
		DotExportVisualization {

	public AuthorOrganizationDotExportVisualization(String outputFile) {
		super(outputFile);
	}
